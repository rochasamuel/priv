...
const IconInput: FunctionComponent<IconInputProps> = ({
	...
	return (
		<div
			className={
				"flex h-10 w-full items-center rounded-md border border-input bg-transparent pl-3 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
			}
		>
			{icon}
			<input
