...
import PasswordRecover from "../PasswordRecovery/PasswordRecover";
...
dark:from-purple-900 dark:via-[#2b1932] dark:to-[#18101c]"
    >
      <div className="max-w-[90dvw]">
        <img
          className="w-full"
          src="https://d384rvovcanpvp.cloudfront.net/assets/img/logos/logo-white-text.svg"
          alt=""
        />
        <div className="lg:text-2xl mt-2">
          Desfrute do prazer de fazer parte!
        </div>
      </div>
      <PasswordRecover />
    </div>
