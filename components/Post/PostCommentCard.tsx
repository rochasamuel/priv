    ...
    >
      ...
      <div className="flex flex-col ml-2">
        <div className="text-xs font-bold">
          {comment.presentationName}
          {loadingPublish && (
            <span className="text-xs opacity-40 font-normal italic ml-2">
      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="max-w-[95vw] md:max-w-[50vw] md:max-h-[90dvh] lg:max-w-[45vw]">
          <AlertDialogHeader>
